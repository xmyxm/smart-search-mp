export const pluginInfoList = [
		...
		{
			name: '物流发货插件',
			icon: 'https://img.meituan.net/dpmobile/f80b58290863ee2c938cec6950b1f3d02450.png.webp',
			path: 'plugin://logisticsPlugin/index?appid=wxddad6eb2e48f7db3',
		},
]
// const _ = Date.now()
